    ...
    { server, role }: ServerHeaderProps) 
{
    ...
    return (
        <DropdownMenu>
            ...
            >
                <button
                    className="w-full text-md font-semibold px-3 flex items-center h-12 border-primary/10 border-b-2 hover:bg-zinc-700/20 dark:hover:bg-zinc-700/50 transition"
                >
                    {server.name}
